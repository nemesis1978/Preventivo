...
- Location: C:\Users\egixt\OneDrive\Desktop\Preventivo\frontend\tests-e2e\example.spec.ts:10:5
...
Call log:
  - waiting for getByRole('link', { name: 'Get started' })
    ...
    at C:\Users\egixt\OneDrive\Desktop\Preventivo\frontend\tests-e2e\example.spec.ts:14:57
```
